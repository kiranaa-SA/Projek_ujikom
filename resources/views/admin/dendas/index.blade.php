...
<div class="container py-4">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #457de4; color: white;">
            ...
            <a href="{{ route('admin.dendas.create') }}" class="btn" style="background-color: #1d37df; color: white; border: none;">
                Tambah Denda
            </a>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr class="text-nowrap">
                            ...
                            <td class="text-nowrap">
                                <a href="{{ route('admin.dendas.show', $denda->id) }}" class="btn btn-info btn-sm mb-1" title="Detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('admin.dendas.edit', $denda->id) }}" class="btn btn-warning btn-sm mb-1" title="Edit">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <form action="{{ route('admin.dendas.destroy', $denda->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus denda ini?')">
                                    @csrf
                                    @method('DELETE')
