...
@section('title', 'Admin Perpus - Edit Pengembalian')
...
<div class="container py-4">
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            {{-- Form --}}
            <form action="{{ route('admin.pengembalians.update', $pengembalian->id) }}" method="POST" class="p-3 border rounded bg-light shadow-sm">
                @csrf
                @method('PUT')
