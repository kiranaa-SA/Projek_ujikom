...
@section('title', 'Admin Perpus - Tambah Pengembalian')
...
<div class="container py-4">
    <div class="card shadow-sm">
        ...
        <div class="card-header" style="background-color: #457de4; color: white;">
            <h3 class="mb-0">Tambah Pengembalian</h3>
        </div>
        ...
        <div class="card-body">
            ...
            {{-- Form --}}
            <form action="{{ route('admin.pengembalians.store') }}" method="POST" class="p-3 border rounded bg-light shadow-sm">
                @csrf
