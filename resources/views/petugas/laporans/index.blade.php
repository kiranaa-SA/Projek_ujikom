...
<div class="container py-4">
    <div class="card shadow-sm">
        ...
        <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #457de4;">
            ...
            <a href="{{ route('petugas.laporans.exportPdf', request()->query()) }}" 
               class="btn" 
        ...
        <div class="card-body">
            {{-- Filter --}}
            <form method="GET" action="{{ route('petugas.laporans.index') }}" class="row g-3 mb-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <a href="{{ route('petugas.laporans.index') }}" class="btn btn-secondary">Reset</a>
                </div>
            </form>
